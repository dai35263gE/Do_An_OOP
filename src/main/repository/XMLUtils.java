...
public class XMLUtils {
  ...
  public static List<Map<String, String>> docFileXML(String tenFile) {
    ...
    try {
      ...
      if (fixedXmlContent.startsWith("\ufeff")) {
        fixedXmlContent = fixedXmlContent.substring(1);
      }

      DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
      DocumentBuilder builder = factory.newDocumentBuilder();

      Document doc = builder.parse(new ByteArrayInputStream(fixedXmlContent.getBytes(StandardCharsets.UTF_8)));
