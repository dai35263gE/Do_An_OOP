...
public class TabManager {
  ...
  private JPanel taoTabQuanLyChuyenBay() {
    ...
    // === SỬA ĐỔI: Thêm nút Xóa chuyến ===
    String[][] cbActions = {
            { "Thêm chuyến", "✈️", "Thêm chuyến bay mới" },
            { "Sửa chuyến", "✏️", "Sửa chuyến bay đã chọn" },
            { "Xóa chuyến", "❌", "Xóa chuyến bay đã chọn (phải ở trạng thái HỦY)" }, // <-- NÚT MỚI
  ...
  private JPanel taoTabQuanLyVe() {
    ...
    // Sửa đổi: Thêm nút "Liên hệ KH"
    String[][] veActions = {
            { "Thêm vé", "🎫", "Thêm vé mới" },
            { "Sửa vé", "✏️", "Sửa vé đã chọn" },
            { "Xóa vé", "❌", "Xóa vé đã chọn" },
            { "Tìm kiếm", "🔍", "Tìm kiếm vé" },
            { "Liên hệ KH", "📧", "Gửi email cho khách hàng của vé này" }, // <-- NÚT MỚI
            { "Làm mới", "🔄", "Làm mới dữ liệu" }
    };
    // Kết thúc sửa đổi
